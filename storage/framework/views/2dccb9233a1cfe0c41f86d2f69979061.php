        ...
        <div class="relative z-10 h-full flex items-center justify-center text-center">
            <div class="max-w-[800px] mx-auto px-6">
                ...
                <p class="text-white/85 text-lg mobile:text-xl mb-6 max-w-xl mx-auto">
                    From durable vinyl to eco-friendly kraft, choose the perfect material for your custom stickers and labels.
                </p>
        ...
        <div class="max-w-[1200px] mx-auto px-6">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-body text-base leading-relaxed mb-8">
                    At MeisaiPrinting, we offer an extensive selection of label and sticker materials to meet every application need. Whether you need waterproof durability for outdoor use, food-safe materials for packaging, or sustainable options for eco-conscious brands, we have you covered. Our materials are carefully sourced and tested to ensure optimal print quality, adhesion, and longevity.
                </p>
                <a href="#quote-form" class="btn-primary inline-block text-base px-10 py-4">
    ...
    <section class="py-16 bg-bg-form">
        <div class="max-w-[1200px] mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="section-heading mb-4">Browse by Material</h2>
                <p class="text-body text-base max-w-2xl mx-auto">
                    Select from our comprehensive range of premium materials designed for various applications.
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 tablet:grid-cols-4 gap-6">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        ...
                        $linkUrl = '/materials/' . $category->slug;
        ...
        <div class="relative z-10 h-full flex items-center justify-center text-center">
            <div class="max-w-[700px] mx-auto px-6">
                <h2 class="text-white text-3xl mobile:text-4xl tablet:text-page-title font-bold leading-tight mb-6">
                    Quality Materials, Global Standards
                </h2>
                <a href="#quote-form" class="btn-primary inline-block text-base px-10 py-4">
                    Get a Quote Now
                </a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.quote-form','data' => ['pageSource' => 'materials']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['pageSource' => 'materials']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', [
    'seoTitle' => 'Custom Materials – MeisaiPrinting',
    'seoDescription' => 'Explore our wide range of custom label and sticker materials. From vinyl to kraft paper, find the perfect material for your needs.',
    'transparentOnTop' => false,
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\ms2\resources\views/materials/index.blade.php ENDPATH**/ ?>