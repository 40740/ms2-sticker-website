...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', '控制面板'); ?> – MeisaiPrinting 管理后台</title>
...
<body class="min-h-screen bg-gray-100" x-data="{ sidebarOpen: false }">
    ...
    <aside class="fixed top-0 left-0 z-40 h-screen w-[250px] transition-transform lg:translate-x-0"
        ...
        <div class="flex h-16 items-center px-6 border-b border-white/10">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-xl font-bold text-white tracking-wide">
            ...
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route($item['route'])); ?>"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors duration-150
                          <?php echo e($isActive ? 'bg-white/15 text-white' : 'text-gray-300 hover:bg-white/10 hover:text-white'); ?>">
    ...
    <div class="lg:ml-[250px]">
        ...
        <header class="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-8">
            ...
            <h1 class="text-lg font-semibold text-gray-800"><?php echo $__env->yieldContent('title', '控制面板'); ?></h1>

            <div class="flex items-center gap-4">
                <span class="text-sm text-gray-500"><?php echo e(auth()->user()?->name ?? '管理员'); ?></span>
                <div class="h-8 w-8 rounded-full bg-[#FF008A] flex items-center justify-center text-white text-sm font-bold">
                    <?php echo e(strtoupper(substr(auth()->user()?->name ?? '管', 0, 1))); ?>
...
<?php /**PATH D:\laragon\www\ms2\resources\views/layouts/admin.blade.php ENDPATH**/ ?>