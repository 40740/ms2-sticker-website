        ...
        <div class="relative z-10 h-full flex items-center justify-center text-center">
            <div class="max-w-[800px] mx-auto px-6">
                ...
                <p class="text-white/85 text-lg mobile:text-xl mb-6 max-w-xl mx-auto">
                    <?php echo e($category->hero_subtitle ?? "Perfectly shaped {$category->name} for your custom stickers and labels."); ?>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-[1200px] mx-auto px-6">
            <p class="text-body text-base leading-relaxed max-w-3xl mx-auto text-center">
                <?php echo e($category->description ?? "Create unique {$category->name} stickers and labels that stand out. Perfect for branding, product packaging, promotions, and more."); ?>
        ...
        <div class="max-w-[1200px] mx-auto px-6">
            <div class="text-center mb-12">
                ...
                <p class="text-body text-base max-w-2xl mx-auto">
                    Browse our selection of custom products in <?php echo e($category->name); ?> shape.
                </p>
            </div>
...
<?php endif; ?>
    ...
    <?php if($relatedProducts->count() > 0): ?>
        <section class="py-16 bg-white">
            <div class="max-w-[1200px] mx-auto px-6">
                <div class="text-center mb-12">
                    <h2 class="section-heading mb-4">More Shapes</h2>
                    <p class="text-body text-base max-w-2xl mx-auto">
                        Explore other shape options for your custom stickers and labels.
                    </p>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.quote-form','data' => ['pageSource' => 'shape-{$category->slug}']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['pageSource' => 'shape-{$category->slug}']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', [
    ...
    'seoDescription' => $category->description ?? "Custom {$category->name} stickers and labels from MeisaiPrinting. Premium quality, factory direct pricing.",
    'transparentOnTop' => false,
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\ms2\resources\views/shapes/show.blade.php ENDPATH**/ ?>