...
@section('content')
    ...
    <section class="relative w-full h-[300px] mobile:h-[400px] overflow-hidden">
        <div class="absolute inset-0">
            <img src="/images/page-hero-{{ $slug }}.jpg"
                 alt="{{ $page['title'] }}"
            ...
            <div class="hidden absolute inset-0 bg-brand/80 items-center justify-center">
                <div class="text-center text-white p-6">
                    <h1 class="text-3xl mobile:text-4xl tablet:text-hero font-bold">{{ $page['title'] }}</h1>
                </div>
            </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-[1200px] mx-auto px-6">
            <div class="max-w-3xl mx-auto">
                ...
                {{-- Material Sample Pack Page --}}
                @elseif($slug === 'material-sample-pack')
                ...
                @elseif($slug === 'artwork-guidelines')
                ...
                @elseif($slug === 'privacy-policy')
                    <div class="space-y-8">
                        ...
                        <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                            <p class="text-body text-base"><strong>{{ \App\Models\Setting::get('site_name', 'MeisaiPrinting') }}</strong></p>
                            @php($contactEmail = \App\Models\Setting::get('contact_email'))
                            @php($contactPhone = \App\Models\Setting::get('contact_phone'))
                            @if($contactEmail)
                                <p class="text-body text-base">Email: {{ $contactEmail }}</p>
                            @endif
                            @if($contactPhone)
                                <p class="text-body text-base">Phone: {{ $contactPhone }}</p>
                            @endif
                        </div>
                    </div>
                ...
                @else
                    ...
                    <h2 class="text-[40px] font-bold text-[#222] leading-tight mb-6">{{ $page['title'] }}</h2>
                    <p class="text-body text-base leading-relaxed">
    ...
    {{-- 5. Quote Form --}}
    <x-quote-form pageSource="page-{$slug}" />
