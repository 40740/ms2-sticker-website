<footer class="footer mt-auto">
    <div class="max-w-[1200px] mx-auto px-6 pt-16 pb-8">
        <div class="grid grid-cols-1 mobile:grid-cols-2 tablet:grid-cols-4 gap-10">
            {{-- Column 1: About --}}
            <div>
                <h4 class="footer-title text-xl mb-5">{{ \App\Models\Setting::get('site_name', 'MeisaiPrinting') }}</h4>
                <p class="text-footer-text text-sm leading-relaxed mb-6">
                    {{ \App\Models\Setting::get('footer_about', 'MeisaiPrinting is a professional custom sticker and label printing manufacturer with over 24 years of experience. We provide high-quality adhesive solutions for businesses worldwide.') }}
                </p>
                {{-- Social Icons --}}
                <div class="flex items-center gap-4">
                    <a href="{{ \App\Models\Setting::get('social_facebook', '#') }}" class="text-footer-text hover:text-brand transition-all duration-300" aria-label="Facebook">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="{{ \App\Models\Setting::get('social_instagram', '#') }}" class="text-footer-text hover:text-brand transition-all duration-300" aria-label="Instagram">
                    ...
                    <a href="{{ \App\Models\Setting::get('social_youtube', '#') }}" class="text-footer-text hover:text-brand transition-all duration-300" aria-label="YouTube">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    <a href="{{ \App\Models\Setting::get('social_tiktok', '#') }}" class="text-footer-text hover:text-brand transition-all duration-300" aria-label="TikTok">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        ...
                        <a href="mailto:{{ \App\Models\Setting::get('contact_email', 'info@meisaiprinting.com') }}" class="text-footer-text hover:text-brand transition-all duration-300">
                            {{ \App\Models\Setting::get('contact_email', 'info@meisaiprinting.com') }}
                        </a>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-brand shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <a href="tel:{{ \App\Models\Setting::get('contact_phone', '+1-800-123-4567') }}" class="text-footer-text hover:text-brand transition-all duration-300">
                            {{ \App\Models\Setting::get('contact_phone', '+1-800-123-4567') }}
                        </a>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-brand shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <span class="text-footer-text">
                            {{ \App\Models\Setting::get('contact_address', '123 Sticker Lane, Printing City, CA 90001, USA') }}
                        </span>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex flex-col mobile:flex-row items-center justify-between gap-4 text-sm text-footer-text">
            <p>&copy; {{ date('Y') }} {{ \App\Models\Setting::get('site_name', 'MeisaiPrinting') }}. All rights reserved.</p>
